...
public class ImageLoader {
    ...
    public static ImageListener getCommonViewImageListener(final View view,
            final int defaultImageResId, final int errorImageResId) {
        return new ImageListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
    ...
    public static Bitmap getRoundedTopLeftCornerBitmap(Bitmap bitmap, int round) {
    ...
    public static ImageListener getRoundListener(final View view,
                                                           final int defaultImageResId, final int errorImageResId) {
        return new ImageListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                if (response.getBitmap() != null) {
                    ...
                    Bitmap bmp = getRoundedTopLeftCornerBitmap(response.getBitmap(), 8);

                    if(Build.VERSION.SDK_INT >= 16){
                        view.setBackground(new BitmapDrawable(view.getResources(), bmp));
                    }else {
                        view.setBackgroundDrawable(new BitmapDrawable(view.getResources(), bmp));
                    }
                } else if (defaultImageResId != 0) {
                    view.setBackgroundResource(defaultImageResId);
                }
