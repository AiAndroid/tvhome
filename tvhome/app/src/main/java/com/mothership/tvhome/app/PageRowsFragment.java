...
public class PageRowsFragment extends BaseRowsFragment {
    ...
    private static final String TAG = "PageRowsFragment";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectAnimatorDuration = getResources().getInteger(
                android.support.v17.leanback.R.integer.lb_browse_rows_anim_duration);
        mRowScaleFactor = getResources().getFraction(
                android.support.v17.leanback.R.fraction.lb_browse_rows_scale, 1, 1);
    }
